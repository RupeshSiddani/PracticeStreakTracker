...
enum SpeechSound: String, Codable, CaseIterable, Identifiable {
    ...
    var exercises: [ExerciseStep] {
        ...
        case .r:
            return [
                ExerciseStep(title: "🧘 Jaw & Tongue Warm-Up", instruction: "Open your mouth wide like a yawn — hold 3 seconds — close.\nRepeat 5 times.\n\nNow: stick your tongue out, move it LEFT ↔ RIGHT slowly 5 times.\nThis loosens the muscles you'll need for R.", icon: "face.smiling", durationSeconds: 20),
                ExerciseStep(title: "🏍️ Motorcycle Engine", instruction: "Press your lips together loosely and blow air to make a \"BRRR\" motorboat sound.\n\nImagine you're revving a motorcycle engine!\nDo this for 5 seconds, rest, repeat 4 times.\n\nThis trains the tongue vibration you need for R.", icon: "waveform", durationSeconds: 25),
                ExerciseStep(title: "🐯 Tiger Growl", instruction: "Curl the back of your tongue UP slightly.\nNow make a deep, low \"GRRRRR\" like an angry tiger.\n\nHold each growl for 4 seconds.\nFeel the vibration? That's your R sound forming!\nRepeat 5 times.", icon: "waveform", durationSeconds: 25),
                ExerciseStep(title: "🔤 R Sound Isolation", instruction: "Try saying just \"RRRR\" by itself — no vowel, just the pure R.\n\nTip: Pull your tongue back slightly, raise the sides to touch your upper back teeth.\nThe middle of your tongue should NOT touch the roof.\n\nHold \"RRRR\" for 3 seconds, relax, repeat 6 times.", icon: "mouth.fill", durationSeconds: 30),
                ExerciseStep(title: "🗣️ R Words — Slow & Clear", instruction: "Say each word SLOWLY. Stretch the R sound:\n\n🔴 Rrr-ed… Rrr-ain… Rrr-iver… Rrr-obot… Rrr-ocket\n🟠 Ca-RR-ot… Mi-RR-or… Ga-RR-age… Pa-RR-ot… Pi-RR-ate\n⭐ Sta-R… Doo-R… Tige-R… Wate-R… Flowe-R\n\nRepeat any tricky ones twice!", icon: "character.bubble", durationSeconds: 35),
                ExerciseStep(title: "🌀 Tongue Twisters", instruction: "Read each one slowly, then try a little faster:\n\n1. \"Red lorry, yellow lorry\" (×3)\n2. \"Round and round the rugged rocks the ragged rascal ran\"\n3. \"Robert the robot raced a red rocket to the river\"\n\nDon't rush — clarity beats speed!", icon: "quote.bubble.fill", durationSeconds: 35),
                ExerciseStep(title: "📖 Story Time — R Sentences", instruction: "Read this mini-story aloud, slowly and clearly:\n\n\"Every morning, Roger the parrot rides a red rocket over the river. He roars like a tiger, races through the rain, and returns home for carrots and strawberries.\"\n\nRepeat 2 times. You're doing incredible! 🎉", icon: "book.fill", durationSeconds: 35),
                ExerciseStep(title: "🎯 Real Life Practice", instruction: "Say these everyday phrases clearly:\n\n• \"Can I have a glass of water?\"\n• \"Turn right at the corner\"\n• \"I really like your shirt\"\n• \"The weather is great today\"\n• \"Where is the restroom?\"\n\nThink about using these in real conversations today!", icon: "person.wave.2.fill", durationSeconds: 30),
                ExerciseStep(title: "🧊 Cool Down & Reflection", instruction: "Amazing session! You're building real progress.\n\nTake 3 slow deep breaths:\n  Breathe in (4 sec)… Hold (4 sec)… Out (4 sec)…\n\n💡 Challenge: Pick ONE R-word from today and use it 5 times in conversation.\n\nYour tongue is getting stronger every single day!", icon: "sparkles", durationSeconds: 15)
            ]
        case .s:
            return [
